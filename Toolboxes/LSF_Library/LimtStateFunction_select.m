% % ------------------------  Example List --------------------------------
% % -----------------------------------------------------------------------
% eg1: FBSS four-branch series system  
% eg2: Single failure surface, U-shaped failure surface  
% eg3: Multiple failure domains, 3 design points  
% eg4: MRF: Modified Rastrigin function, discontinuous failure domain  
% eg5: Linear limit-state function, i.e., HDHP high-dimensional hyperplane  
% eg6: DRONLO spring-mass oscillator  
% eg7: 6-dimensional elasto-plastic frame  
% eg8: N-dimensional paraboloid  
% eg9: 10D TSWMFM: Truss structure with multiple failure modes  
% eg10: Infinite discontinuity example  
% eg11: 2D sector-shaped failure domain  
% eg12: 2-degree-of-freedom spring-mass oscillator under white noise  
% eg13: VSIP: vehicle side impact problem  
% eg14: Base-isolated structure with combined failure of isolator and structure  
% eg15: 6D high-dimensional nonlinear mathematical example  
% eg16: 2D jumping discontinuity example  
% eg17: Three-span four-story planar frame example  
% eg18: 23-bar truss (dimension of random input is 10)  
% eg19: ANSYS truss example  
% eg20: N-dimensional dynamic example (white noise excitation, 3-story structure)  
% eg21: Dynamic example (deterministic real earthquake, 2 random variables, can discuss dynamic DOFs)  
% eg22: Dynamic example (deterministic real earthquake, discussing number of random variables)  
% eg23: ANSYS - isoAP1000 - response spectrum analysis  
% eg24: A toy example in AL-GP  
% eg25: Ishigami function  
% eg26: SFstru_sinInput (3-story shear frame with Bouc-Wen model and sinusoidal input)  
% eg27: FBSS_V2  
% eg28: eg28Function  
% eg29: eg29Function % Book Lü, page 186  
% eg30: To test the banana-shaped PDF
...
% -------------------------------------------------------------------------
% % Force the use of a limit-state function in the standard normal space
% if exist('SBM')
%     if strcmp(SBM.method,'SDMCS')
%         ProSys.fun_par.StadNrom = 'Yes';
%     end
