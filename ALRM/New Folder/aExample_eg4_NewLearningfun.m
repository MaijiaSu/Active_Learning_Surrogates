...
ALSMPar.IniDoE.VM = 1;
ALSMPar.LF_type = 'MoV-distance';                      % lerarning function， = 'MoV', 'TwoStepLF','TwoStepL_modified'
ALSMPar.LF_Par.Kernel = 'TwoStepLF_GaussianKernel'; % 'TwoStepLF_GaussianKernel','TwoStepLF_DiracKernel'
ALSMPar.LF_Par.LearnFun = 'P';                      % LearnFunction: 'U','P'
ALSMPar.LF_Par.c = 1e2;                           % penality
